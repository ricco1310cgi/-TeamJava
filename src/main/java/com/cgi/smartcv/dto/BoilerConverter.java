...
public class BoilerConverter {
	...
	public Boiler convertStringToBoilerDTO(String inputString, Boiler boiler) {
		...
		// Fill the boilerDTO
		boiler = new Boiler(Integer.parseInt(inputs[2]), Float.parseFloat(inputs[3]), Float.parseFloat(inputs[4]),
				Boolean.parseBoolean(inputs[5]), Long.parseLong(inputs[6]), Float.parseFloat(inputs[7]),
